package tech.sharply.metch.engine.modules.trading.application.commands.update_order_command
...
) : CommandHandler<UpdateOrderCommand, Order>, BusinessRuleValidator {

    override fun handle(request: UpdateOrderCommand): Order {
        ...
        return orderBook.update(request.orderId, request.price, request.size)!!
    }
