...
class PlaceOrderCommandHandler(
    ...
    override fun handle(request: PlaceOrderCommand): Order {
        val orderBook = tradingEngine.findOrderBookByInstrument(request.instrument)
        // TODO: Run business checks
        ...
        if (request.type == OrderType.MARKET) {
            ...
            if (compatibleOrders.isEmpty()) {
                throw ExceptionWithCode("order.cannotDetermineMarketPrice.insufficientOrdersOnOppositeAction",
